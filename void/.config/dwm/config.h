...
static const char col_gray4[]       = "#7dcfff";
static const char col_cyan[]        = "#24283b";
static const char col_border[]      = "#6da8c4";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_s,      spawn,          SHCMD("mkdir -p /home/abxijth/Pictures/Screenshots && scrot '/home/abxijth/Pictures/Screenshots/%Y-%m-%d_%H-%M-%S.png' -e 'xclip -selection clipboard -t image/png -i $f'") },
